...
def test_create_csv_files_a():
    ...
    with open(temp_out_a) as file:
        ...
        expected = (
            ...
            "Gemeentenummer;0505\n"
            "\n"
            "Kieskringnummer;Gemeentenummer;Gemeentenaam;Stembureaunummer;Stembureaunaam;Aantal geen verklaring (zoals ingevuld);Aantal geen verklaring (som van opgegeven verklaringen);Al hergeteld\n"
            "14;0505;Dordrecht;1;Stembureau Binnenstad (postcode: 3331 DA);2;;x of ja\n"
        )
